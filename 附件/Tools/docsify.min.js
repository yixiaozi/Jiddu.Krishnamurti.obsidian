    ...
    var ie, oe, ae = function t(e) {
        ...
        return c.sanitize = function (e, t) {
            ...
            if (Y || O(t), c.removed = [], "string" == typeof e && (re = !1), !re)
                if (e instanceof p) 1 === (t = (r = _e("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === t.nodeName || "HTML" === t.nodeName ? r = t : r.appendChild(t);
                else {
            ...
            return e.prototype.space = function (e) {
                ...
                if (t) {
                    ...
                    if (!this.options.pedantic && /^</.test(n)) {
                        ...
                        var r = Bt(t[2], "()"); - 1 < r && (o = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r, t[2] = t[2].substring(0, r), t[0] = t[0].substring(0, o).trim(), t[3] = "")
                    }
                    var i, r = t[2],
                        o = "";
